...
public class LongestIncreasingSubsequence {
    ...
    //another explanation:
    /*
     * I use an array dp[] to store the largest elements in the increasing subsequences and the array's index 
     * is the length of the subsequence (since this, we can make sure that the array dp[] is in-order). 
...
length 2 subsequence is '3' ([2,3]) and the largest element in a length 3 subsequence is '9' ([2,4,9]) by far.
